...
const { getHeroSlides, getHeroSlideById, createHeroSlide, updateHeroSlide, deleteHeroSlide, toggleHeroSlideStatus, updateHeroSlidePriority } = require('../controllers/heroSlideController');
